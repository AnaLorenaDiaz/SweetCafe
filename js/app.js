...
function colorBlink(selector) {
	$(selector).animate({opacity: '1',}, {step: function () {$(this).css('color', 'orange');},queue: true})
	.animate({opacity: '1'}, {step: function () {$(this).css('color', 'yellow');},queue: true}, 600)
	.delay(500)
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'lime');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'aquamarine');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'cyan');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'DeepSkyBlue');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'blue');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'darkMagenta');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'Magenta');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'crimson');},queue: true})
  .animate({opacity: '1'}, {step: function () {$(this).css('color', 'red');},queue: true})
	.animate({opacity: '1'}, {step: function () {$(this).css('color', 'OrangeRed');colorBlink('h1.main-titulo');},queue: true});
}
